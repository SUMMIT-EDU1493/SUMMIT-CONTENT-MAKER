...
export default function HighTestPage() {
  ...
  const [result, setResult] = useState<HighComicResult | null>(null);
      ...
      <div className="mx-auto max-w-6xl">
        <div>
          ...
          <p className="mt-3 text-slate-600">
            이미지 생성 없이 본문 분할과 4컷 설계안만 확인하는 테스트 페이지야.
          </p>
        </div>
          ...
          {!loadingPdf && pdfText && (
            <div className="mt-5 rounded-xl bg-emerald-50 p-4 text-emerald-700">
              ...
              <p className="mt-1 text-sm">
                약 {pdfText.length.toLocaleString()}자
              </p>
            </div>
          )}
        </section>
        ...
        {pdfText && (
          <section className="mt-6 rounded-3xl bg-purple-50 p-6 ring-1 ring-purple-200">
            ...
            <h2 className="mt-1 text-2xl font-black text-slate-900">
              본문 의미 블록 + 써밋네컷 설계안 생성
            </h2>

            <p className="mt-2 text-sm text-slate-600">
              아직 이미지 생성은 하지 않아. 텍스트 설계안만 확인하는 단계야.
            </p>
          ...
          <section className="mt-10">
            <div className="rounded-3xl bg-slate-900 p-6 text-white">
              ...
              <div className="mt-5 inline-flex rounded-full bg-white/10 px-4 py-2 font-bold">
                총 {result.blockCount || result.plans.length}개 써밋네컷
              </div>
            </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-5">
                      ...
                      <div className="mt-3 flex flex-wrap gap-2">
                        {plan.keyWords?.map((word, wordIndex) => (
                          <span
                            key={`${word}-${wordIndex}`}
